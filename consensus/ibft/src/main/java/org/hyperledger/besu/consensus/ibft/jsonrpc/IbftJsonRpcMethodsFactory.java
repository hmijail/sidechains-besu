...
import org.hyperledger.besu.crosschain.ethereum.api.jsonrpc.internal.methods.CrossAddLinkedNode;
...
import org.hyperledger.besu.crosschain.ethereum.api.jsonrpc.internal.methods.CrossListLinkedNodes;
...
public class IbftJsonRpcMethodsFactory implements JsonRpcMethodFactory {
  ...
  public Map<String, JsonRpcMethod> createJsonRpcMethods(final Collection<RpcApi> jsonRpcApis) {
    ...
    if (jsonRpcApis.contains(RpcApis.CROSSCHAIN)) {
      ...
      addMethods(
          rpcMethods,
          new CrossAddLinkedNode(crosschainController, jsonRpcParameter),
          ...
          new CrossListLinkedNodes(crosschainController),
