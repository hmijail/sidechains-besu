...
public class CrosschainTransaction extends Transaction {
  public enum CrosschainTransactionType {
    ...
    ORIGINATING_LOCKABLE_CONTRACT_DEPLOY(
        Constants.ORIGINATING_LOCKABLE_CONTRACT_DEPLOY), // TODO This isn't currently supported.
    SUBORDINATE_LOCKABLE_CONTRACT_DEPLOY(
        Constants.SUBORDINATE_LOCKABLE_CONTRACT_DEPLOY), // TODO This isn't currently supported.
